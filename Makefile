...
DISTDIR = /Users/medmachrouh/Desktop/Current\ Projects/Final\ Project\ CPP/Sudoku/.tmp/Sudoku1.0.0
...
LIBS          = $(SUBLIBS) -F/usr/local/lib -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework DiskArbitration -framework IOKit -framework AGL -framework OpenGL   
...
SOURCES       = main.cpp \
		sudokugame.cpp moc_sudokugame.cpp
OBJECTS       = main.o \
		sudokugame.o \
		moc_sudokugame.o
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/clang-mac.conf \
		...
		Sudoku.pro sudokugame.h main.cpp \
		sudokugame.cpp
QMAKE_TARGET  = Sudoku
DESTDIR       = 
...
EXPORT__PRO_FILE_ = /Users/medmachrouh/Desktop/Current Projects/Final Project CPP/Sudoku/Sudoku.pro


include /usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules
...
Makefile: Sudoku.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.2.2/share/qt/mkspecs/common/macx.conf \
...
Sudoku.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Sudoku,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Sudoku,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},11,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Sudoku,g" -e "s,@LIBRARY@,Sudoku,g" -e "s,\$${EXECUTABLE_NAME},Sudoku,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >Sudoku.app/Contents/Info.plist
...
distdir: FORCE
	...
	$(COPY_FILE) --parents sudokugame.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp solver.cpp sudokugame.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_sudokugame.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_sudokugame.cpp
moc_sudokugame.cpp: sudokugame.h \
		solver.cpp \
		moc_predefs.h \
		/usr/local/share/qt/libexec/moc
	/usr/local/share/qt/libexec/moc $(DEFINES) --include '/Users/medmachrouh/Desktop/Current Projects/Final Project CPP/Sudoku/moc_predefs.h' -I/usr/local/share/qt/mkspecs/macx-clang -I'/Users/medmachrouh/Desktop/Current Projects/Final Project CPP/Sudoku' -I'/Users/medmachrouh/Desktop/Current Projects/Final Project CPP/Sudoku' -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/12.0.5/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/usr/local/lib sudokugame.h -o moc_sudokugame.cpp
...
main.o: main.cpp sudokugame.h \
		solver.cpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

sudokugame.o: sudokugame.cpp sudokugame.h \
		solver.cpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sudokugame.o sudokugame.cpp

moc_sudokugame.o: moc_sudokugame.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_sudokugame.o moc_sudokugame.cpp
